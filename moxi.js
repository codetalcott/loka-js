(()=>{
	...
	let mxh = window.moxi ??= {}
	let nm = mxh.name ??= (e, k)=>k                  // "live" / "on-" / "mx-ignore"
	let evh = mxh.event ??= (e, v)=>v                // event name after prefix
	let modf = mxh.modifier ??= (m)=>m               // dotted modifier name
