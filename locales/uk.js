...
// Source: hyperfixi/packages/semantic/src/generators/profiles/ukrainian.ts (events)
...
//   'ukrainian' profile (reviewed by that project), except any entry
//   overridden in loka-js/scripts/fx-vocab.mjs, which is loka-local. To
//   suggest corrections, edit fx-vocab.mjs (LOCALES.uk) and regenerate.
window.loka.register('uk', {
  fixi: {
    attrs: {
      'fx-дія': 'fx-action',
      'fx-метод': 'fx-method',
