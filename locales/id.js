...
// Source: hyperfixi/packages/semantic/src/generators/profiles/indonesian.ts (events)
...
//   'indonesian' profile (reviewed by that project), except any entry
//   overridden in loka-js/scripts/fx-vocab.mjs, which is loka-local. To
//   suggest corrections, edit fx-vocab.mjs (LOCALES.id) and regenerate.
window.loka.register('id', {
  fixi: {
    attrs: {
      'fx-aksi': 'fx-action',
      'fx-metode': 'fx-method',
