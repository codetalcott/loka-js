// Verbatim copy of bigskysoftware/ssexi@ba5492dc — NOT patched.
// ssexi fires "fx:sse:<type>" events on the DOM (no attributes of its own).
// Localization is achieved purely from outside: the orchestrator listens for
// canonical "fx:sse:open" etc. and re-fires localized aliases ("fx:sse:abrir")
// on the same target. No patch surface needed.
